...
<form method="post" action="{{ route('books.store') }}" class="container" enctype="multipart/form-data" >
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="writerName" value="{{old('writerName')}}" placeholder="Enter writerName">
        @error('writerName')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
